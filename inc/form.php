...
function uncomplicated_seo_options(){
    ...
    if(isset($_POST['enviar'])){
        ...
        $namearray = array( 
            __('Twitter Username', 'uncomplicated_seo'),
...
?>
    <div class="wrap">
        ...
        <form method="post">
            ...
            <br><input type="submit" id="enviar" class="button button-primary" name="enviar" value="<?php echo __('Update', 'uncomplicated_seo'); ?>"/>
        </form>
    </div>
<?php
    }
